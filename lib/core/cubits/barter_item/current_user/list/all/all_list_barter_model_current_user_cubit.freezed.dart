...
class _$AllListBarterModelCurrentUserStateTearOff {
  const _$AllListBarterModelCurrentUserStateTearOff();
...
const $AllListBarterModelCurrentUserState =
    _$AllListBarterModelCurrentUserStateTearOff();

mixin _$AllListBarterModelCurrentUserState {
  ...
  $AllListBarterModelCurrentUserStateCopyWith<
      AllListBarterModelCurrentUserState> get copyWith;
}

abstract class $AllListBarterModelCurrentUserStateCopyWith<$Res> {
  factory $AllListBarterModelCurrentUserStateCopyWith(
          AllListBarterModelCurrentUserState value,
          $Res Function(AllListBarterModelCurrentUserState) then) =
      _$AllListBarterModelCurrentUserStateCopyWithImpl<$Res>;
  $Res call(
...
class _$AllListBarterModelCurrentUserStateCopyWithImpl<$Res>
    implements $AllListBarterModelCurrentUserStateCopyWith<$Res> {
  _$AllListBarterModelCurrentUserStateCopyWithImpl(this._value, this._then);

  final AllListBarterModelCurrentUserState _value;
  // ignore: unused_field
  final $Res Function(AllListBarterModelCurrentUserState) _then;
...
class __$PrivateListBarterModelCurrentUserStateCopyWithImpl<$Res>
    extends _$AllListBarterModelCurrentUserStateCopyWithImpl<$Res>
...
abstract class _PrivateListBarterModelCurrentUserState
    implements AllListBarterModelCurrentUserState {
